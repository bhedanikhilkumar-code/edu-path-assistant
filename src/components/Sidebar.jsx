...
import { BookOpen, MessageSquare, HelpCircle, Layers, Compass, BarChart3, Network, ChevronLeft, ChevronRight, CheckCircle2, AlertCircle } from 'lucide-react';
...
export default function Sidebar({ currentView, onViewChange, hasContext }) {
  ...
  const menuItems = [
    ...
    { id: 'mindmap', label: 'Concept MindMap', icon: Network, description: 'Visual knowledge graph' },
